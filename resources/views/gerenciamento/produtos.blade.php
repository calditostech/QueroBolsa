...
@section('content')
<!-- Barra do logo -->
  <div class="container-gerencia-produtos">
  <nav class="barra-gerencia-produtos">
    <p class="painel-gerencia-produtos" href="/">Painel<b>Quero</b> 1.0<br><p class="indexrop">Index de Roupas</p></p>
    <img src = "{{ url('assets/img/logoapp.png') }}" class="logo-cidades">
  </div>
</nav>

<!-- Menu Retratil -->
<nav class="sidebar-gerencia-produtos">
  <ul>
