...
@section('content')
<!-- Barra do logo -->
  <div class="container-md-categorias">
  <nav class="barra-cadastro-categorias">
    <p class="painel-cadastro-categorias" href="/">Painel<b>Quero</b> 1.0<br><p class="indexrop">Index de Roupas</p></p>
    <img src = "{{ url('assets/img/logoapp.png') }}" class="logo-categorias">
  </div>
</nav>
